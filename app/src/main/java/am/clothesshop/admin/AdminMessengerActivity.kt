...
class AdminMessengerActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_admin_messenger)
                ...
                object :
                    ...
                    override fun onBindViewHolder(
                        ...
                        holder.itemView.setOnClickListener {
                            ...
                            val intent =
                                Intent(this@AdminMessengerActivity, ThisChatActivity::class.java)
